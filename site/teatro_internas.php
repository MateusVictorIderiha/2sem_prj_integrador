    ...
    <article class="container teatro_content">
        <h1 class="titulo text-center teatro_titulo_pos"><?=$teatro['title']?></h1>
            <div class="row text-justify">
                ...
                <img class="cat_img img-fluid mx-auto d-block col-12 col-lg-6" src="midia/teatro/<?=$teatro['imagemUm']?>.jpg" alt="<?=$teatro['altUm']?>" title="<?=$teatro['creditoUm']?>">
                    <img class="cat_img img-fluid mx-auto d-block col-12 col-lg-6" src="midia/teatro/<?=$teatro['imagemDois']?>.jpg" alt="<?=$teatro['altDois']?>" title="<?=$teatro['creditoDois']?>">
