<div class="container">
    <article class="row" id="conteudo_principal">
        <div class="col-md-4 col-12" class="text-center">
            <h1 class="text-center titulo">História do Origami</h1>
	...
	<section class="row col-12 col-md-6">
		...
		<a href="index.php?pagina=origami">
		    <img class="img-rounded img-responsive center-block imgHome  mw-100" style="height: 160px; width: 280px;" src="midia/origame/origameHome2.jpg" alt="Origami de um passaro feito em papel da cor roxa">
		</a>
	    </div>
	    <div class="col-12 col-md-6">
		<a href="index.php?pagina=origami">
		    <h3 class="text-align-center" class="">Origami Tsuru</h3>
		</a>
	...
	<section class="row col-12 col-md-6">
		    ...
		    <img class="img-rounded img-responsive center-block imgHome mw-100" style="height: 140px; width: 250px;" src="midia/origame/OrigameHome3.jpg" alt="Origami representando um dragão feito em papel da cor branca">
		</a>
            </div>
            <div class="col-12 col-md-6">
		<a href="index.php?pagina=origami2">
		    <h3>Origami: Dragão</h3>
		</a>
                <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto eius libero accusamus corporis, earum corrupti, quaerat quasi molestiae hic, nobis distinctio dignissimos</p>
                <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto eius libero accusamus corporis, earum corrupti, quaerat quasi molestiae hic, nobis distinctio dignissimos</p>
            </div>
    ...
    <hr class="hrOrigami">
        ...
        <div class="row">
		    ...
		    <h3 class="text-center">Faça Borboletas </h3>
