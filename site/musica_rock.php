...
<div class="container p-2">
    <div class="row">
        <div class="col-md-4">
            <article>
                <h2 class="text-center subtitulo">J-Rock</h2>
                <picture>
                    ...
                    <img class="img-fluid img-thumbnail" src="midia/musicas/logo_r.jpg" alt="img">
                </picture>
        ...
        <div class="col-md-8">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="text-center">Hata Motohiro</h3>
                        <picture>
                    ...
                    <div class="col-md-6">
                        <h3 class="text-center">Moshimo</h3>
                        <picture>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="text-center">Scandal</h3>
                        <picture>
                    ...
                    <div class="col-md-6">
                        ...
                        <picture>
                            <source media="(max-width: 720px)" srcset="midia/musicas/iki_gakari_2.jpg">
                            <source media="(min-width: 720px)" srcset="midia/musicas/iki_gakari_2.jpg">
                            <source media="(min-width: 1200px)" srcset="midia/musicas/iki_gakari_2.jpg">
                            <img class="img-fluid img-thumbnail rounded-circle m-2 float-left" style="width: 175px; height: 175px" src="midia/musicas/iki_gakari_2.jpg" alt="imagem de uma banda de j-pop denominada de ...">
                        </picture>
                        <p class="text-justify">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit tempore id quia voluptate laboriosam quibusdam in accusamus animi provident neque harum sed eius, consequatur odit quas sint officiis ducimus dolor? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit tempore id quia voluptate laboriosam quibusdam in accusamus animi provident neque harum sed eius, consequatur odit quas sint officiis ducimus dolor?</p>
                        <p class="text-justify">
