        ...
        <div class="col-lg-8 col-md-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-xs-12">
                    <aside>
                        <picture>
                            <source media="(max-width: 720px)" srcset="midia/danca/RoupasDanca_700.jpg">
                            <source media="(min-width: 720px)" srcset="midia/danca/RoupasDanca_700.jpg">
                            <source media="(min-width: 1200px)" srcset="midia/danca/RoupasDanca_700.jpg">
                            <img class="img-fluid imgTopicoDanca" src="midia/danca/RoupasDanca_700.jpg" alt="duas moças moças japonesas com roupas tipicas de dança japonesa" style="width:auto;">	
                        </picture>
                    </aside>
                </div>
            </div>
